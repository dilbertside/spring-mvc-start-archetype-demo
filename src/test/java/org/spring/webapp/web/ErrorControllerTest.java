...
public class ErrorControllerTest extends WebSecurityConfigurationAware {
  ...
  /**
   * Test method for {@link org.spring.webapp.web.ErrorController#generalError(javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse, org.springframework.ui.Model)}.
   * 
   * @throws Exception
   */
  @Test
